...
layout = dbc.Col([
    ...
    html.P("By Daniel Azevedo", className="text-info"),
    html.Hr(),
    ...
    dbc.Row([
                ...
                dbc.Row([
                    dbc.Col([
                       ...
                       dcc.DatePickerSingle(id="date-receitas",
                           ...
                           max_date_allowed=date(2070, 12, 31),
                           date=datetime.today(),
                           style={"width": "100%"}                 
                       ), 
                    ], width=4),
        ...
        dbc.Modal([
            ...
            dbc.ModalBody([
                    ...
                    dbc.Col([
                        dbc.Label("Descrição: "),
                        dbc.Input(placeholder="Ex.: Gasolina, luz...", id="txt-despesa"),
                    ], width=6),
                    dbc.Col([
                        dbc.Label("Valor: "),
        ...
        ], style={"background-color": "rgba(220, 20, 60, 0.5)"},
